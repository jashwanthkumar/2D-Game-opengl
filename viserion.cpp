...
Viserion::Viserion(float x, float y, color_t color) {
	...
	for(int i = 0;i < 20; i += 1)
	{
		...
		g_vertex_buffer_data[9*i+3]=0.60f;	
		g_vertex_buffer_data[9*i+4]=0.0f;	
		g_vertex_buffer_data[9*i+5]=0.0f;	
		g_vertex_buffer_data[9*i+6]= g_vertex_buffer_data[9*i+3]*cos(2*3.14159265359/20) - g_vertex_buffer_data[9*i+4]*sin(2*3.14159265359/20);	
		g_vertex_buffer_data[9*i+7]= g_vertex_buffer_data[9*i+3]*sin(2*3.14159265359/20) + g_vertex_buffer_data[9*i+4]*cos(2*3.14159265359/20);	
