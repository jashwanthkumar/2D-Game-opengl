...
Ground::Ground(float x, float y, color_t color) {
    ...
    static const GLfloat vertex_buffer_data[] = {
        ...
        -1.0f,-5.25f, 0.0f,
        1.0f, -5.25f, 0.0f, // triangle 1 : end
        1.0f,-1.0f,0.0f, // triangle 1 : begin
        -1.0f,-1.0f, 0.0f,
        1.0f, -5.25f, 0.0f,
        -3.0f,-1.0f,0.0f, // triangle 1 : begin
        -3.0f,-5.25f, 0.0f,
        -1.0f, -5.25f, 0.0f, // triangle 1 : end
        -1.0f,-1.0f,0.0f, // triangle 1 : begin
        -3.0f,-1.0f, 0.0f,
        ...
        1.0f,-1.0f,0.0f, // triangle 1 : begin
        1.0f,-5.25f, 0.0f,
        3.0f, -5.25f, 0.0f, // triangle 1 : end
        3.0f,-1.0f,0.0f, // triangle 1 : begin
        1.0f,-1.0f, 0.0f,
        3.0f, -5.25f, 0.0f,
        3.0f,-1.0f,0.0f, // triangle 1 : begin
        3.0f,-5.25f, 0.0f,
        5.0f, -5.25f, 0.0f, // triangle 1 : end
        5.0f,-1.0f,0.0f, // triangle 1 : begin
        3.0f,-1.0f, 0.0f,
        5.0f, -5.25f, 0.0f,
        -3.0f,-1.0f,0.0f, // triangle 1 : begin
        -3.0f,-5.25f, 0.0f,
