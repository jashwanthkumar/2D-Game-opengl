#include "bullets.h"
#include "main.h"
Bullets::Bullets(float x, float y, color_t color) {
...
void Bullets::set_position(float x, float y) {
    this->position = glm::vec3(x, y, 0);
}

void Bullets::tick(int sign) {
    // this->rotation += 5.0;
    this->position.x += speed * sign/10;
    // this->position.y += speedy;
}

bounding_box_t Bullets::bounding_box()
{
    bounding_box_t temp;
